...
def main():
    ...
    if request.method == 'POST':
        ...
        basic_sec.add(authentication_types=security_profile['authentication-types'], mode=security_profile['mode'], name=security_profile['name'], supplicant_identity=security_profile['supplicant-identity'], wpa_pre_shared_key=obj['ssid2_pw'], wpa2_pre_shared_key=obj['ssid2_pw'])
